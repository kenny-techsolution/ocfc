...
angular.module("btford.socket-io", []).provider("socketFactory", function () {
	...
	this.$get = ["$rootScope", "$timeout", function (t, e) {
		...
		return function (e) {
			e = e || {};
			var r = e.ioSocket || io.connect(), u = e.prefix || n, c = e.scope || t, i = function (n, t) {
				r.on(n, t.__ng = o(r, t))
			}, a = function (n, t) {
				r.once(n, t.__ng = o(r, t))
			}, s = {on: i, addListener: i, once: a, emit: function (n, t, e) {
				var u = arguments.length - 1, e = arguments[u];
				return"function" == typeof e && (e = o(r, e), arguments[u] = e), r.emit.apply(r, arguments)
				...
				n instanceof Array == !1 && (n = [n]), t || (t = c), n.forEach(function (n) {
					var e = u + n, c = o(r, function (n) {
						t.$broadcast(e, n)
					});
					t.$on("$destroy", function () {
						r.removeListener(n, c)
					}), r.on(n, c)
				})
			}};
			return s
