...
//4.29.2014, updated code to include churchAdmin and worldAdmin authorization ends
	...
	$routeProvider
		...
		.when('/approveFellowship', {templateUrl: '/partials/fellowship/approve-fellowship', controller: 'FellowshipCtrl',resolve: { checklogin: checkLogin}})
		...
		.when('/fellowship/:id/members', {templateUrl: '/partials/church/fellowship-members', controller: 'FellowshipMembersCtrl',resolve: { checklogin: checkLogin}})
