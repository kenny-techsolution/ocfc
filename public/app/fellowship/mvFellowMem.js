/*************************************************************************************
 This file creates a new Controller called mvFellowMem

 creates a resource called fellowMemResource

 fellowMemResource:   Takes rest /api/fellowMems/:id using GET method to grab records
                      for specific user
 ***************************************************************************************/

//factory, is a singleton, that contains data or function that can be used across controllers
