...
// across controllers
angular.module('app').factory('ImageCommentApiSvc', function ($resource) {
	// rest api standard, for GET, if id is specified, it will grab specific
	// user by id

	var imageCommentResource = $resource('/api/images/:image_id/comments', {
		image_id:'@image_id'
	}, {
		'update': {
			method: 'PUT',
