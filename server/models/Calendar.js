...
var calendarSchema = mongoose.Schema({
	...
	fellowshipId:	{type: ObjectId, ref:'Fellowship', index: true, unique: false,lowercase: true},
	...
	updatedOn:		{type: Date, Required:'(updatedOn) is required!', index: true, unique: false,lowercase: true, default: Date.now}
});
