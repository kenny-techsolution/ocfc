...
exports.commentSchema = mongoose.Schema({
	userId:		{type: ObjectId, ref:'User', Required:'(userId) is required!', index: false, lowercase: true},
	...
	createdOn:	{type: Date,index: false, unique: false,lowercase: true, default: Date.now},
	updatedOn:	{type: Date,index: false, unique: false,lowercase: true, default: Date.now}
});